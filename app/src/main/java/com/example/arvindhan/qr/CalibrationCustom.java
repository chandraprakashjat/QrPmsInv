...
public class CalibrationCustom extends ArrayAdapter<String> {
    ...
    public CalibrationCustom(Activity context, ArrayList<String> maintenance,
        ...
        super(context, R.layout.activity_calibration_custom, maintenance);
    ...
    public View getView(int position, View View, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.activity_calibration_custom, null, true);
