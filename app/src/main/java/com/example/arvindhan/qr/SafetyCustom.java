...
public class SafetyCustom extends ArrayAdapter<String> {
    ...
    public SafetyCustom(Activity context, ArrayList<String> maintenance,
        ...
        super(context, R.layout.activity_safety_custom, maintenance);
    ...
    public View getView(int position, View View, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.activity_safety_custom, null, true);
