...
public class ParameterListPressure extends AppCompatActivity implements SearchView.OnQueryTextListener {
...
//        hsv =(HorizontalScrollView) findViewById(R.id.hsv);
        ...
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(ParameterListPressure.this);
        ...
        Title_parameter.setText("PRESSURE");
...
//        });
        ...
        if (activeNetwork != null && activeNetwork.isConnected()) {
            ...
            Toast.makeText(ParameterListPressure.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
...
//                String data = (String) m_list.getItemAtPosition(position);
                ...
                Intent i=new Intent(ParameterListPressure.this,ParameterCompletion.class);
                startActivity(i);
                finish();
            }
        });
        ...
        R_pms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                Intent inn = new Intent(ParameterListPressure.this, Home.class);
                startActivity(inn);
                finish();
    ...
    private void AlertDialogView() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ParameterListPressure.this);
...
//                                Toast.LENGTH_SHORT).show();
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                l6.clear();
                if (takeValue=="1"){
                    Intent i=new Intent(ParameterListPressure.this,ParameterList.class);
                    startActivity(i);
                    finish();
                } else if (takeValue=="2"){
                    Intent i=new Intent(ParameterListPressure.this,ParameterListPressure.class);
                    startActivity(i);
                    finish();
                } else if (takeValue=="3"){
                    Intent i=new Intent(ParameterListPressure.this,ParameterListInsulation.class);
                    startActivity(i);
                    finish();
                } else if (takeValue=="4"){
                    Intent i=new Intent(ParameterListPressure.this,ParameterListVibration.class);
                    startActivity(i);
                    finish();
                }
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Toast.makeText(ParameterListPressure.this, "Fail", Toast.LENGTH_SHORT)
                        .show();
            }
        });
    ...
    public class AsyncCheckLogin extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = ProgressDialog.show(ParameterListPressure.this, "Please wait...","It may take few seconds to Load...", true);
            ...
            if (activeNetwork != null && activeNetwork.isConnected()) {
                if (registerstatus.equalsIgnoreCase("Success")) {
                    ...
                    if (configsecond.smallestScreenWidthDp >= 600) {
                        final ParameterCustomTab adapter = new ParameterCustomTab(ParameterListPressure.this, l1, l2, l3, l4, l5, l6);
                        listview.setAdapter(adapter);
                    } else {
                        final ParameterCustom adapter = new ParameterCustom(ParameterListPressure.this, l1, l2, l3, l4, l5, l6);
                        listview.setAdapter(adapter);
                    }
                    ...
                    showAlertDialog(ParameterListPressure.this, "No Record's Available!",
                            "This Equipment Not Having This Particular Record", false);
                } else if (registerstatus.equalsIgnoreCase("")) {
                    Toast.makeText(ParameterListPressure.this, strMsg, Toast.LENGTH_LONG).show();

                } else if (registerstatus.equalsIgnoreCase("null")) {
                    Toast.makeText(ParameterListPressure.this, strMsg, Toast.LENGTH_LONG).show();

                } else {
                    Toast.makeText(ParameterListPressure.this, "Successful", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(ParameterListPressure.this, "Internet Connection Failed ! Please Try Again", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void call() {
        try {
            ...
            request.addProperty("parametertype", "2");
    ...
    public void onBackPressed() {
        Intent i = new Intent(ParameterListPressure.this,HomeSub.class);
        startActivity(i);
        finish();
