...
public class DueoverdueCustom extends ArrayAdapter<String> {
    ...
    public DueoverdueCustom(Activity context, ArrayList<String> maintanance,
        ...
        super(context, R.layout.activity_dueoverdue_custom, maintanance);
    ...
    public View getView(int position, View View, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.activity_dueoverdue_custom, null, true);
