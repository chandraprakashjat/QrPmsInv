...
public class SafetyList extends AppCompatActivity implements SearchView.OnQueryTextListener{
...
//        done=(Button)findViewById(R.id.done);
        ...
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(SafetyList.this);
...
//        });
        ...
        if (activeNetwork != null && activeNetwork.isConnected()) {
            ...
            Toast.makeText(SafetyList.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }

        Configuration configsecond = getResources().getConfiguration();
        if (configsecond.smallestScreenWidthDp >= 600) {
            final SafetyCustomTab adapter = new SafetyCustomTab(SafetyList.this, l1,l2,l3,l4,l5,l6);
            listview.setAdapter(adapter);
        } else {
            final SafetyCustom adapter = new SafetyCustom(SafetyList.this, l1,l2,l3,l4,l5,l6);
            listview.setAdapter(adapter);
        }
...
//                String data = (String) m_list.getItemAtPosition(position);
                ...
                Intent i=new Intent(SafetyList.this,SafetyCompletion.class);
                startActivity(i);
                finish();
        ...
        R_pms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                Intent inn = new Intent(SafetyList.this, Home.class);
                startActivity(inn);
                finish();
...
//            @Override
//            public void onClick(View view) {
//                c = (CheckBox) view.findViewById(R.id.check);
...
//                        String item = String.valueOf(listview.getItemAtPosition(checked.keyAt(i)));
////                        listview = (ListView) view.findViewById(R.id.list);
//
//                        Toast.makeText(SafetyList.this, item, Toast.LENGTH_SHORT).show();
//                    } else {
//                        Toast.makeText(SafetyList.this, "failed", Toast.LENGTH_SHORT).show();
//                    }
//
//                }
//            }
//        });
    ...
    public class AsyncCheckLogin extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = ProgressDialog.show(SafetyList.this, "Please wait...","It may take few seconds to Load...", true);
...
//                    check.add(l6);
                    ...
                    showAlertDialog(SafetyList.this, "Alert !!",
                            "No Record's Available", false);
                } else if (registerstatus.equalsIgnoreCase("")) {
                    Toast.makeText(SafetyList.this, "Server is not connected.Try after sometimes!", Toast.LENGTH_LONG).show();

                } else {
                    Toast.makeText(SafetyList.this, "Successful", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(SafetyList.this, "Internet Connection Failed ! Please Try Again", Toast.LENGTH_SHORT).show();
            }
        }
    }
...
//
    ...
    public void onBackPressed() {
        Intent i = new Intent(SafetyList.this,HomeSub.class);
        startActivity(i);
        finish();
