...
/**
 * Created by Arvindhan on 11/24/2017.
 */

public class CustomListTab  extends ArrayAdapter<String> {
    ...
    public CustomListTab (Activity context, ArrayList<String> maintenance,
        ...
        super(context, R.layout.custom_list_tab, maintenance);
    ...
    public View getView(int position, View View, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.custom_list_tab, null, true);
