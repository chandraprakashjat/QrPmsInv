...
public class ParameterCustomTab extends ArrayAdapter<String> {
    ...
    public ParameterCustomTab(Activity context, ArrayList<String> maintenance,
        ...
        super(context, R.layout.activity_parameter_custom_tab, maintenance);
    ...
    public View getView(int position, View View, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.activity_parameter_custom_tab, null, true);
