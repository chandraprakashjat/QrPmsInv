...
public class SafetyCustomTab extends ArrayAdapter<String> {
    ...
    public SafetyCustomTab(Activity context, ArrayList<String> maintenance,
        ...
        super(context, R.layout.activity_safety_custom_tab, maintenance);
    ...
    public View getView(int position, View View, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.activity_safety_custom_tab, null, true);
