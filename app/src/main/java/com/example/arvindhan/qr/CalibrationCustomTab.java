...
/**
 * Created by Arvindhan on 11/25/2017.
 */

public class CalibrationCustomTab extends ArrayAdapter<String> {
    ...
    public CalibrationCustomTab(Activity context, ArrayList<String> maintenance,
        ...
        super(context, R.layout.activity_calibration_custom_tab, maintenance);
    ...
    public View getView(int position, View View, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.activity_calibration_custom_tab, null, true);
