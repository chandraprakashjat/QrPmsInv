...
public class ParameterList extends AppCompatActivity implements OnQueryTextListener{
...
//        hsv =(HorizontalScrollView) findViewById(R.id.hsv);
        ...
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(ParameterList.this);
        ...
        Title_parameter.setText("TEMPERATURE");
...
//        });
        ...
        if (activeNetwork != null && activeNetwork.isConnected()) {
            ...
            Toast.makeText(ParameterList.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
...
//                String data = (String) m_list.getItemAtPosition(position);
                ...
                Intent i=new Intent(ParameterList.this,ParameterCompletion.class);
                startActivity(i);
                finish();
            }
        });
        ...
        R_pms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                Intent inn = new Intent(ParameterList.this, Home.class);
                startActivity(inn);
                finish();
    ...
    private void AlertDialogView() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ParameterList.this);
...
//                        Toast.makeText(getApplicationContext(), takeValue,
//                                Toast.LENGTH_SHORT).show();
                    }
                });
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                l6.clear();
                if (takeValue=="1"){
                    Intent i=new Intent(ParameterList.this,ParameterList.class);
                    startActivity(i);
                    finish();
                } else if (takeValue=="2"){
                    Intent i=new Intent(ParameterList.this,ParameterListPressure.class);
                    startActivity(i);
                    finish();
                } else if (takeValue=="3"){
                    Intent i=new Intent(ParameterList.this,ParameterListInsulation.class);
                    startActivity(i);
                    finish();
                } else if (takeValue=="4"){
                    Intent i=new Intent(ParameterList.this,ParameterListVibration.class);
                    startActivity(i);
                    finish();
                }
...
//        listview.setAdapter(adapter);
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Toast.makeText(ParameterList.this, "Fail", Toast.LENGTH_SHORT)
                        .show();
            }
        });
    ...
    public class AsyncCheckLogin extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = ProgressDialog.show(ParameterList.this, "Please wait...","It may take few seconds to Load...", true);
...
//                    list.add("Parameter Name : " + maintenancecode + "\n" + "Frequency : " + days + "\n" + "Last Done : " + donedate + "\n" + "Next Due   : " + due);
//                    m_code_list.add("Parameter Name : " + maintenancecode + "\n" + "Frequency : " + days + "\n" + "Last Done : "+ donedate + "\n" + "Next Due   : " + due + "\n" +"maintenancecode :"+ maintanance +"\n" +"componentcode :" + componentcode);
//                    data.add(list);
//                    m_data.add(list);
...
//                }
                    ...
                    if (configsecond.smallestScreenWidthDp >= 600) {
                        final ParameterCustomTab adapter = new ParameterCustomTab(ParameterList.this, l1, l2, l3, l4, l5, l6);
                        listview.setAdapter(adapter);
                    } else {
                        final ParameterCustom adapter = new ParameterCustom(ParameterList.this, l1, l2, l3, l4, l5, l6);
                        listview.setAdapter(adapter);
...
//                    Title_parameter.setText("VIBRATION");
//                }
                    showAlertDialog(ParameterList.this, "No Record's Available!",
                            "This Equipment Not Having This Particular Record", false);
                } else if (registerstatus.equalsIgnoreCase("")) {
                    Toast.makeText(ParameterList.this, strMsg, Toast.LENGTH_LONG).show();

                } else if (registerstatus.equalsIgnoreCase("null")) {
                    Toast.makeText(ParameterList.this, strMsg, Toast.LENGTH_LONG).show();

                } else {
                    Toast.makeText(ParameterList.this, "Successful", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(ParameterList.this, "Internet Connection Failed ! Please Try Again", Toast.LENGTH_SHORT).show();
            }
        }
    }
...
//        alertDialog.setIcon((status) ? R.drawable.success : R.drawable.icon);
    ...
    public void call() {
        try {
            ...
            request.addProperty("parametertype", "1");
...
//
    ...
    public void onBackPressed() {
        Intent i = new Intent(ParameterList.this,HomeSub.class);
        startActivity(i);
        finish();
